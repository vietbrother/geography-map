...
import Icon from '../app/screens/MainScreenBase'
...
export default class SearchList extends Component {
  ...
  _renderSectionIndexItem (sectionData, sectionID) {
    return (
      <Text style={{textAlign: 'center', color: this.props.sectionIndexTextColor, fontSize: 14, height: 20, fontFamily: 'Time New Roman'}}>
        {sectionID}
      </Text>
    )
  }
  ...
  _renderRow (item, sectionID, rowID, highlightRowFunc) {
    return <View style={{
      ...
      {/*<VectorIcon name={"ios-map"} size={30} />*/}
